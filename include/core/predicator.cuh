...
__device__ __host__ inline query_line_intersect<float, 2> line_intersect(const Line<float, 2> &line) noexcept {
    return query_line_intersect<float, 2>(line);
}
__device__ __host__ inline query_line_intersect<double, 2> line_intersect(const Line<double, 2> &line) noexcept {
    return query_line_intersect<double, 2>(line);
}
__device__ __host__ inline query_line_intersect<float, 3> line_intersect(const Line<float, 3> &line) noexcept {
    return query_line_intersect<float, 3>(line);
}
__device__ __host__ inline query_line_intersect<double, 3> line_intersect(const Line<double, 3> &line) noexcept {
...
template <typename Real, unsigned int dim> struct query_nearest_silhouette {
    using vector_type = typename vector_of<Real, dim>::type;

    __device__ __host__ query_nearest_silhouette(const vector_type &tgt, const bool flip_normal_orientation) : target(tgt), flip_normal_orientation(flip_normal_orientation) {}
...
__device__ __host__ inline query_nearest_silhouette<float, 2> nearest_silhouette(const float2 &point, const bool flip_normal_orientation) noexcept {
    return query_nearest_silhouette<float, 2>(point, flip_normal_orientation);
}
__device__ __host__ inline query_nearest_silhouette<double, 2> nearest_silhouette(const double2 &point, const bool flip_normal_orientation) noexcept {
    return query_nearest_silhouette<double, 2>(point, flip_normal_orientation);
}

__device__ __host__ inline query_nearest_silhouette<float, 3> nearest_silhouette(const float4 &point, const bool flip_normal_orientation) noexcept {
    return query_nearest_silhouette<float, 3>(point, flip_normal_orientation);
}
__device__ __host__ inline query_nearest_silhouette<float, 3> nearest_silhouette(const float3 &point, const bool flip_normal_orientation) noexcept {
    return query_nearest_silhouette<float, 3>(make_float4(point.x, point.y, point.z, 0.0f), flip_normal_orientation);
}
__device__ __host__ inline query_nearest_silhouette<double, 3> nearest_silhouette(const double4 &point, const bool flip_normal_orientation) noexcept {
    return query_nearest_silhouette<double, 3>(point, flip_normal_orientation);
}
__device__ __host__ inline query_nearest_silhouette<double, 3> nearest_silhouette(const double3 &point, const bool flip_normal_orientation) noexcept {
